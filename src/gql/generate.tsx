...
export type InstalledAppEdge = {
    __typename?: 'InstalledAppEdge';
    /** A cursor for use in pagination. */
    cursor: Scalars['String'];
    /** The item at the end of the edge. */
    node?: Maybe<App>;
...
export type PendingCollaboratorEdge = {
    __typename?: 'PendingCollaboratorEdge';
    /** A cursor for use in pagination. */
    cursor: Scalars['String'];
    /** The item at the end of the edge. */
    node?: Maybe<User>;
...
export type ProjectTeamEdge = {
    __typename?: 'ProjectTeamEdge';
    /** A cursor for use in pagination. */
    cursor: Scalars['String'];
    /** The item at the end of the edge. */
    node?: Maybe<Team>;
    /** The HTTP path for this project's team */
    projectTeamResourcePath: Scalars['URI'];
    /** The HTTP URL for this project's team */
    projectTeamUrl: Scalars['URI'];
};
...
export type RepositoryContributorEdge = {
    __typename?: 'RepositoryContributorEdge';
...
export type StarredTopicEdge = {
    __typename?: 'StarredTopicEdge';
    /** A cursor for use in pagination. */
    cursor: Scalars['String'];
    node: Topic;
    /** Identifies when the item was starred. */
...
export type TeamEligibilityEdge = {
    __typename?: 'TeamEligibilityEdge';
    /** A cursor for use in pagination. */
    cursor: Scalars['String'];
    /** The item at the end of the edge. */
    node?: Maybe<Team>;
...
export type TransferIssueInput = {
    /** The ID of the issue to be transferred */
    issueId: Scalars['ID'];
    /** The ID of the repository the issue should be transferred to */
    repositoryId: Scalars['ID'];
    /** A unique identifier for the client performing the mutation. */
    clientMutationId?: Maybe<Scalars['String']>;
};
...
export type RepositoryStarMutationVariables = {
    id: Scalars['ID'];
};

export type RepositoryStarMutation = { __typename?: 'Mutation' } & {
    addStar: Maybe<
        { __typename?: 'AddStarPayload' } & {
            starrable: Maybe<
                { __typename?: 'Repository' | 'Topic' | 'Gist' } & Pick<
                    Starrable,
                    'id' | 'viewerHasStarred'
                >
            >;
...
export type RepositoryUnstarMutationVariables = {
    id: Scalars['ID'];
};

export type RepositoryUnstarMutation = { __typename?: 'Mutation' } & {
    removeStar: Maybe<
        { __typename?: 'RemoveStarPayload' } & {
            starrable: Maybe<
                { __typename?: 'Repository' | 'Topic' | 'Gist' } & Pick<
...
export type ViewerRepositoryAllQueryVariables = {
    ...
    orderByField?: Maybe<RepositoryOrderField>;
};
...
export const RepositoryStarDocument = gql`
...
export const RepositoryStarComponent = (
    props: Omit<
        Urql.MutationProps<
            RepositoryStarMutation,
            RepositoryStarMutationVariables
        >,
        'query'
    > & { variables?: RepositoryStarMutationVariables },
) => <Urql.Mutation {...props} query={RepositoryStarDocument} />;

export const RepositoryUnstarDocument = gql`
...
export const RepositoryUnstarComponent = (
    props: Omit<
        Urql.MutationProps<
            RepositoryUnstarMutation,
            RepositoryUnstarMutationVariables
        >,
        'query'
